 ...
 *                 message:
 *                   type: string
 *                   example: 'Email verified successfully! Welcome to Fuse19.'
 *                 data:
 *                   type: object
 *                   properties:
 *                     user:
 ...
 *                 message:
 *                   type: string
 *                   example: 'If an account with that email exists and is unverified, we have sent a new verification email.'
 */
...
router.get('/verify-status', auth, getVerificationStatus);
