...
export class MessagesService {
    ...
    create(message: Message): Observable<Message> {
        return this.messages$.pipe(
            ...
            switchMap((messages) =>
                this._httpClient
                    .post<Message>(`${environment.apiUrl}/common/messages`, { message })
                    .pipe(
                        map((newMessage) => {
    ...
    update(id: string, message: Message): Observable<Message> {
        return this.messages$.pipe(
            ...
            switchMap((messages) =>
                this._httpClient
                    .patch<Message>(`${environment.apiUrl}/common/messages`, {
                        id,
                        message,
                    })
                    .pipe(
    ...
    delete(id: string): Observable<boolean> {
        return this.messages$.pipe(
            ...
            switchMap((messages) =>
                this._httpClient
                    .delete<boolean>(`${environment.apiUrl}/common/messages`, { params: { id } })
                    .pipe(
    ...
    markAllAsRead(): Observable<boolean> {
        return this.messages$.pipe(
            ...
            switchMap((messages) =>
                this._httpClient
                    .get<boolean>(`${environment.apiUrl}/common/messages/mark-all-as-read`)
                    .pipe(
