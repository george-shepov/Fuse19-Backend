...
export class ContactsService {
    ...
    private getApiUrl(endpoint: string): string {
        return environment.useRealApi ? `${environment.apiUrl}/${endpoint}` : `api/apps/${endpoint}`;
    }
    ...
    getContacts(): Observable<Contact[]> {
        return this._httpClient.get<any>(this.getApiUrl('contacts')).pipe(
            map(response => environment.useRealApi ? response.data : response),
            tap((contacts) => {
    ...
    searchContacts(query: string): Observable<Contact[]> {
        return this._httpClient
            .get<any>(this.getApiUrl('contacts/search'), {
                params: { query },
            })
            .pipe(
                map(response => environment.useRealApi ? response.data : response),
    ...
    createContact(): Observable<Contact> {
        return this.contacts$.pipe(
            ...
            switchMap((contacts) =>
                this._httpClient
                    .post<any>(this.getApiUrl('contacts'), {})
                    .pipe(
                        map((response) => {
                            const newContact = environment.useRealApi ? response.data : response;
    ...
    updateContact(id: string, contact: Contact): Observable<Contact> {
        return this.contacts$.pipe(
            ...
            switchMap((contacts) =>
                this._httpClient
                    .put<any>(this.getApiUrl(`contacts/${id}`), contact)
                    .pipe(
                        map((response) => {
                            const updatedContact = environment.useRealApi ? response.data : response;
    ...
    deleteContact(id: string): Observable<boolean> {
        return this.contacts$.pipe(
            ...
            switchMap((contacts) =>
                this._httpClient
                    .delete<any>(this.getApiUrl(`contacts/${id}`))
                    .pipe(
                        map((response) => {
                            const isDeleted = environment.useRealApi ? response.success : response;
