...
export class TasksService {
    ...
    getTags(): Observable<Tag[]> {
        return this._httpClient.get<any>(this.getApiUrl('tasks/tags')).pipe(
    ...
    getTasks(): Observable<Task[]> {
        return this._httpClient.get<any>(this.getApiUrl('tasks')).pipe(
            map(response => environment.useRealApi ? response.data : response),
            tap((response) => {
    ...
    searchTasks(query: string): Observable<Task[] | null> {
        return this._httpClient.get<any>(this.getApiUrl('tasks/search'), {
            params: { query },
        });
    }
